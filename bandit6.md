sử dụng file */{.,}* để liệt kê tất cả các file có trong thư mục hiện tại và cả các file con của chúng. Và chúng ta nhận thấy những file có ASCII text là những file đọc đc
